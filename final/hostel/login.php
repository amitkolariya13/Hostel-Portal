 ...
 <form id="RegisterUserForm" action="login_status1.php" method="post">
 	...
 	<fieldset>
         ...
         <p>
			...
			<?php if(isset($_SESSION['fail'])) {echo "<b>Does not exit";}unset($_SESSION['fail']); if(isset($_SESSION['regsuccess'])) 
			{echo "<b><i><font color='red'>Registration Success.....</font>";}unset($_SESSION['regsuccess']);
			?>
 	</fieldset>
